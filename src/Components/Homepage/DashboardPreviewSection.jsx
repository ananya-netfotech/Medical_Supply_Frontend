  ...
  return (
    <section className="relative overflow-hidden bg-white py-24">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-14 overflow-hidden rounded-[2.25rem] border border-blue-100 bg-white p-[1px] shadow-[0_30px_90px_rgba(15,23,42,0.12)]">
          <div className="relative overflow-hidden rounded-[calc(2.25rem-1px)] bg-gradient-to-br from-white via-blue-50/40 to-slate-50">
            ...
            <div className="relative z-10 border-b border-blue-100/80 p-4 sm:p-5">
            ...
            <div className="relative z-10 grid gap-0 lg:grid-cols-[0.36fr_0.64fr]">
              <div className="border-b border-blue-100/80 p-6 sm:p-8 lg:border-b-0 lg:border-r">
                <div
                ...
                >
                  <div className="mb-6 flex items-center justify-between">
                    <div
                      className={`inline-flex items-center gap-2 rounded-full border ${activeDashboard.accent.border} ${activeDashboard.accent.soft} px-4 py-2`}
                    >
                      <Layers3 className={`h-4 w-4 ${activeDashboard.accent.text}`} />
                      <span
                        className={`text-xs font-semibold uppercase tracking-[0.18em] ${activeDashboard.accent.text}`}
                      >
                        Active Preview
                      </span>
                    </div>

                    <span className="rounded-full border border-blue-100 bg-white px-3 py-1.5 text-xs font-semibold text-slate-500 shadow-sm">
                  ...
                  <div className="relative mb-6 inline-flex">
                    ...
                    />
                    <div
                      className={`relative flex h-16 w-16 items-center justify-center rounded-[1.5rem] bg-gradient-to-br ${activeDashboard.accent.gradient} text-white shadow-lg`}
                    >
                      <ActiveIcon className="h-8 w-8" />
                    </div>
                  </div>

                  <h3 className="text-3xl font-bold tracking-tight text-blue-950">
                  ...
                  <div className="mt-6 flex flex-wrap gap-2">
                    {activeDashboard.points.map((point) => (
                      <span
                        key={point}
                        className="rounded-full border border-white bg-white/80 px-3 py-1.5 text-xs font-semibold text-slate-600 shadow-sm"
                      >
                        {point}
                      </span>
                    ))}
                  ...
                  <div className="mt-8 flex items-center gap-3">
                    <button
                      ...
                      className="flex h-11 w-11 items-center justify-center rounded-2xl border border-blue-100 bg-white text-blue-700 shadow-sm transition hover:-translate-y-0.5 hover:bg-blue-50"
                    ...
                    <button
                      ...
                      className={`group inline-flex flex-1 items-center justify-center gap-2 rounded-2xl bg-gradient-to-r ${activeDashboard.accent.gradient} px-5 py-3 font-semibold text-white shadow-lg transition hover:-translate-y-0.5 hover:shadow-xl`}
                    >
                      Next dashboard
            ...
            <div className="relative z-10 border-t border-blue-100/80 px-6 py-4">
              <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 text-xs font-semibold uppercase tracking-[0.16em] text-slate-400">
        ...
        <div className="relative mt-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-6">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-blue-100 bg-white px-4 py-2 shadow-sm">
              ...
              <span className="text-xs text-slate-600">dashboard previews</span>
            </div>
          </div>
        </div>
      </div>
...
function DashboardImagePreview({ dashboard }) {
  return (
    <div className="relative overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white p-3 shadow-[0_18px_50px_rgba(15,23,42,0.10)]">
      ...
      <div className="relative z-10 overflow-hidden rounded-[1.35rem] border border-slate-100 bg-slate-100">
        <img
          src={dashboard.image}
          alt={dashboard.alt}
        ...
        <div
          className={`absolute bottom-4 left-4 rounded-full border border-white/70 bg-white/90 px-3 py-1.5 text-xs font-semibold ${dashboard.accent.text} shadow-sm backdrop-blur-sm`}
        >
          Temporary dashboard screenshot
        </div>

        <div className="absolute right-4 top-4 rounded-full border border-white/70 bg-white/90 px-3 py-1.5 text-xs font-semibold text-slate-600 shadow-sm backdrop-blur-sm">
          Replaceable PNG
        </div>
      </div>
    </div>
