...
function OutcomeCard({ icon: Icon, title, description, index }) {
  ...
  return (
    <div
      ...
      className="group relative min-h-[230px] overflow-hidden rounded-[1.35rem] border border-blue-100 bg-gradient-to-b from-white to-blue-50/40 p-[1px] shadow-[0_10px_30px_rgba(15,23,42,0.06)] transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-[0_22px_55px_rgba(37,99,235,0.14)]"
      style={{
    ...
    >
      {/* Default card */}
      <div className="relative z-10 h-full rounded-[calc(1.35rem-1px)] bg-white p-6">
      ...
      <div
        ...
        className="absolute inset-0 z-20 bg-[linear-gradient(135deg,#1E3A8A_0%,#2563EB_48%,#312E81_100%)]"
      >
