// ../../../Components/Government/AuditTrail/AuditPagination.jsx
    ...
    <div className="mt-4 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-600">
      <div className="text-sm text-gray-600">
        ...
        <span className="font-medium text-gray-900">
          {Math.min(endIndex, filteredAuditsLength)}
        </span>{" "}
        of{" "}
        <span className="font-medium text-gray-900">{filteredAuditsLength}</span>{" "}
        entries
      </div>
