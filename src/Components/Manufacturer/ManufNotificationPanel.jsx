...
const ManufNotificationsPanel = ({ 
  ...
  return (
    <div 
      ...
      className="absolute right-0 top-12 z-50 w-[420px] max-w-[calc(100vw-2rem)] rounded-xl border border-emerald-200 bg-white shadow-2xl overflow-hidden"
    >
        ...
        <div className="flex items-center gap-1.5">
          {unreadCount > 0 && (
            <button
              ...
              className="flex items-center gap-1 rounded-lg px-1.5 py-1 text-[10px] font-medium text-emerald-600 hover:bg-emerald-50 transition"
            >
      ...
      {/* Filters */}
      <div className="border-b border-emerald-100 bg-emerald-50/30 px-3 py-1.5">
      ...
      <div className="max-h-[320px] overflow-y-auto divide-y divide-slate-100">
        {filteredNotifications.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
            <div className="rounded-full bg-emerald-50 p-2 mb-2">
          ...
          filteredNotifications.map((notif) => {
            ...
            return (
              <div
                key={notif.id}
                className={`relative p-3 transition-all hover:bg-emerald-50/30 cursor-pointer ${
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1">
                        <button
                          ...
                          className="rounded p-0.5 text-slate-400 hover:bg-emerald-100 hover:text-emerald-600 transition"
                          title="Mark as read"
                        >
      ...
      {/* Footer */}
      <div className="border-t border-emerald-200 bg-emerald-50/30 px-3 py-2">
        <button className="flex w-full items-center justify-center gap-1.5 rounded-lg bg-white px-3 py-1.5 text-xs font-medium text-emerald-600 transition hover:bg-emerald-50 border border-emerald-200">
