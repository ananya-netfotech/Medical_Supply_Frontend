    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-3xl rounded-2xl bg-white shadow-2xl">
          ...
          <div className="relative h-32 rounded-t-2xl bg-gradient-to-r from-emerald-600 to-teal-700">
            <button
              onClick={onClose}
            ...
            <div className="absolute -bottom-12 left-6">
              <div className="relative">
                <div className="flex h-24 w-24 items-center justify-center rounded-2xl bg-white shadow-lg">
                  <div className="flex h-20 w-20 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-600 to-teal-700 text-2xl font-bold text-white">
                    {user.avatar}
                  </div>
                </div>
                <button className="absolute bottom-0 right-0 rounded-full bg-emerald-600 p-1.5 text-white shadow-lg hover:bg-emerald-700 transition">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      disabled={!isEditing}
                      className="w-full rounded-lg border border-slate-300 pl-10 pr-3 py-2 text-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 disabled:bg-slate-50 disabled:text-slate-500"
                    />
                  </div>
                </div>
