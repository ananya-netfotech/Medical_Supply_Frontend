...
export default function PharmacySecurityModal({ isOpen, onClose, user }) {
          ...
          <div className="flex items-center justify-between border-b border-purple-100 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Manage your pharmacy account security</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="p-6">
            ...
            <div className="mb-6 rounded-lg border border-purple-100 p-4">
              ...
              <p className="text-sm text-slate-600">
                Add an extra layer of security to your pharmacy account by requiring a verification code from your mobile device.
              </p>
              {twoFactorEnabled && (
                <div className="mt-3 rounded-lg bg-purple-50 p-3 border border-purple-200">
                  <p className="text-sm text-purple-800">
                    <strong>2FA is enabled</strong> - Your pharmacy account is protected with two-factor authentication.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="rounded-lg border border-purple-100 p-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between rounded-lg bg-purple-50/50 p-3">
                  ...
                  <span className="rounded-full bg-purple-100 px-2 py-1 text-xs font-medium text-purple-700">Active Now</span>
                </div>
                <button className="w-full rounded-lg border border-purple-200 bg-purple-50 px-4 py-2 text-sm font-medium text-purple-700 transition hover:bg-purple-100">
                  Log out all other devices
                </button>
              </div>
            </div>

            {/* Security Tips - Purple theme */}
            <div className="mt-6 rounded-lg bg-purple-50 p-4 border border-purple-200">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-sm font-semibold text-purple-900">Security Tips</p>
                  <ul className="mt-2 space-y-1 text-xs text-purple-800">
                    <li>• Use a strong, unique password for your pharmacy account</li>
                    <li>• Enable two-factor authentication for added security</li>
                    <li>• Never share your password or verification codes</li>
                    <li>• Regularly review your active sessions</li>
                    <li>• Ensure your pharmacy license information is always up to date</li>
                  </ul>
                </div>
              </div>
            </div>
