...
const PharmacyNotificationsPanel = ({ 
  isOpen, 
  onClose, 
  notifications, 
  onMarkAsRead, 
  ...
  const getTypeStyles = (type) => {
    switch(type) {
      ...
      case "success":
        return { bg: "bg-emerald-50", border: "border-emerald-200", text: "text-emerald-700", iconBg: "bg-emerald-100" };
      default:
        return { bg: "bg-purple-50", border: "border-purple-200", text: "text-purple-700", iconBg: "bg-purple-100" };
    }
  };
  ...
  const getPriorityBadge = (priority) => {
    switch(priority) {
      ...
      case "low":
        return <span className="ml-2 rounded-full bg-emerald-100 px-2 py-0.5 text-[10px] font-semibold text-emerald-700">Low</span>;
      default:
        return null;
    }
  };
  ...
  return (
    <div 
      ...
      className="absolute right-0 top-12 z-50 w-[420px] max-w-[calc(100vw-2rem)] rounded-xl border border-purple-200 bg-white shadow-2xl overflow-hidden"
    >
      {/* Header - Purple theme */}
      <div className="flex items-center justify-between border-b border-purple-200 bg-gradient-to-r from-purple-50 to-white px-4 py-3">
        ...
        <div className="flex items-center gap-1.5">
          {unreadCount > 0 && (
            <button
              ...
              className="flex items-center gap-1 rounded-lg px-1.5 py-1 text-[10px] font-medium text-purple-600 hover:bg-purple-50 transition"
            >
      ...
      {/* Filters */}
      <div className="border-b border-purple-100 bg-purple-50/30 px-3 py-1.5">
      ...
      <div className="max-h-[320px] overflow-y-auto divide-y divide-slate-100">
        {filteredNotifications.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
            <div className="rounded-full bg-purple-50 p-2 mb-2">
          ...
          filteredNotifications.map((notif) => {
            ...
            return (
              <div
                key={notif.id}
                className={`relative p-3 transition-all hover:bg-purple-50/30 cursor-pointer ${
                ...
                <div className="flex gap-2.5">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2 mb-0.5">
                      ...
                      {!notif.read && (
                        <div className="h-1.5 w-1.5 rounded-full bg-purple-600 flex-shrink-0" />
                      )}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1">
                        <button
                          ...
                          className="rounded p-0.5 text-slate-400 hover:bg-purple-100 hover:text-purple-600 transition"
                          title="Mark as read"
                        >
      ...
      {/* Footer */}
      <div className="border-t border-purple-200 bg-purple-50/30 px-3 py-2">
        <button className="flex w-full items-center justify-center gap-1.5 rounded-lg bg-white px-3 py-1.5 text-xs font-medium text-purple-600 transition hover:bg-purple-50 border border-purple-200">
...
export default PharmacyNotificationsPanel;